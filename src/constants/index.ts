...
export const INITIAL_USERS: User[] = [
  ...
  {
    id: '2',
    username: 'manager_hung',
    fullName: 'Trần Thế Hùng',
    email: 'hung.tt@uni.edu.vn',
    phone: '0902345678',
...
export const INITIAL_CATEGORIES: AssetCategory[] = [
  {
    ...
    code: 'LAPTOP',
    description: 'Các loại máy tính xách tay cho cán bộ giảng viên',
    icon: 'fa-laptop',
  },
  {
    id: 'cat2',
    name: 'Máy chiếu',
    code: 'PROJECTOR',
    description: 'Thiết bị trình chiếu tại giảng đường',
    icon: 'fa-video',
  },
  {
    id: 'cat3',
    ...
    code: 'FURNITURE',
    description: 'Nội thất văn phòng và giảng đường',
    icon: 'fa-chair',
  },
  {
    id: 'cat4',
...
export const INITIAL_DEPARTMENTS: Department[] = [
  {
    ...
    code: 'WAREHOUSE',
    managerId: '1',
    description: 'Kho chứa tài sản tổng',
  },
  {
    id: 'd1',
    ...
    code: 'FIT',
    managerId: '2',
    description: 'Phụ trách đào tạo CNTT',
  },
  {
    id: 'd2',
    ...
    history: [
      {
        ...
        date: '2023-10-10',
        description:
          'Nhập lô hàng 3 máy từ Dell Vietnam. Hóa đơn gốc được đính kèm.',
        performedBy: 'Trần Thế Hùng',
        pdfUrl: DUMMY_PDF,
      },
    ],
    items: [
      ...
      {
        id: 'i2',
        assetCode: 'LOT-2023-001-002',
        batchId: 'a1',
        status: AssetItemStatus.IN_STOCK,
      },
      {
        id: 'i3',
        assetCode: 'LOT-2023-001-003',
        batchId: 'a1',
        status: AssetItemStatus.IN_STOCK,
      },
    ],
